...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'isnotequal_floatfloat.cl' */
        source_code = read_buffer("isnotequal_floatfloat.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "isnotequal_floatfloat", &ret);
        if (ret != CL_SUCCESS)
        {
