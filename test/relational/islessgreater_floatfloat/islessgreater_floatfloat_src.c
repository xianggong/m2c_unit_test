...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'islessgreater_floatfloat.cl' */
        source_code = read_buffer("islessgreater_floatfloat.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "islessgreater_floatfloat", &ret);
        if (ret != CL_SUCCESS)
        {
