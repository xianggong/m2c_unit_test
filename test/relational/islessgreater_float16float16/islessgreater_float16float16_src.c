...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'islessgreater_float16float16.cl' */
        source_code = read_buffer("islessgreater_float16float16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "islessgreater_float16float16", &ret);
        if (ret != CL_SUCCESS)
        {
