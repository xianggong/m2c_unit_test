...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'isgreater_floatfloat.cl' */
        source_code = read_buffer("isgreater_floatfloat.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "isgreater_floatfloat", &ret);
        if (ret != CL_SUCCESS)
        {
