...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'isequal_floatfloat.cl' */
        source_code = read_buffer("isequal_floatfloat.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "isequal_floatfloat", &ret);
        if (ret != CL_SUCCESS)
        {
