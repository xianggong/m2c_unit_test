...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'isless_float2float2.cl' */
        source_code = read_buffer("isless_float2float2.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "isless_float2float2", &ret);
        if (ret != CL_SUCCESS)
        {
