...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'islessequal_floatfloat.cl' */
        source_code = read_buffer("islessequal_floatfloat.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "islessequal_floatfloat", &ret);
        if (ret != CL_SUCCESS)
        {
