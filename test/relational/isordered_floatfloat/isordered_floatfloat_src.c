...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'isordered_floatfloat.cl' */
        source_code = read_buffer("isordered_floatfloat.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "isordered_floatfloat", &ret);
        if (ret != CL_SUCCESS)
        {
