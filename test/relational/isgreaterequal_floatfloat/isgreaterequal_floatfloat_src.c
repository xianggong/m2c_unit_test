...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'isgreaterequal_floatfloat.cl' */
        source_code = read_buffer("isgreaterequal_floatfloat.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "isgreaterequal_floatfloat", &ret);
        if (ret != CL_SUCCESS)
        {
