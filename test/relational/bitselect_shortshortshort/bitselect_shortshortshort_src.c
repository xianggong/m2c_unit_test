...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'bitselect_shortshortshort.cl' */
        source_code = read_buffer("bitselect_shortshortshort.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "bitselect_shortshortshort", &ret);
        if (ret != CL_SUCCESS)
        {
