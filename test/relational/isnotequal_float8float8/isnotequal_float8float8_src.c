...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'isnotequal_float8float8.cl' */
        source_code = read_buffer("isnotequal_float8float8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "isnotequal_float8float8", &ret);
        if (ret != CL_SUCCESS)
        {
