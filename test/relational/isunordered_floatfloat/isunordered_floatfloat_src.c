...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'isunordered_floatfloat.cl' */
        source_code = read_buffer("isunordered_floatfloat.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "isunordered_floatfloat", &ret);
        if (ret != CL_SUCCESS)
        {
