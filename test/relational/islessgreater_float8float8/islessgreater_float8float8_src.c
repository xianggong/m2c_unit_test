...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'islessgreater_float8float8.cl' */
        source_code = read_buffer("islessgreater_float8float8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "islessgreater_float8float8", &ret);
        if (ret != CL_SUCCESS)
        {
