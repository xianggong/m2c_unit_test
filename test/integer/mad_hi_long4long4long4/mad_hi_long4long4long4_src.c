...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'mad_hi_long4long4long4.cl' */
        source_code = read_buffer("mad_hi_long4long4long4.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "mad_hi_long4long4long4", &ret);
        if (ret != CL_SUCCESS)
        {
