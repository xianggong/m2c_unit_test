...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'mad_sat_uchar4uchar4uchar4.cl' */
        source_code = read_buffer("mad_sat_uchar4uchar4uchar4.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "mad_sat_uchar4uchar4uchar4", &ret);
        if (ret != CL_SUCCESS)
        {
