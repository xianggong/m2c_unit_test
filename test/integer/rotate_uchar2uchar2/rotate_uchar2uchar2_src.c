...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'rotate_uchar2uchar2.cl' */
        source_code = read_buffer("rotate_uchar2uchar2.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "rotate_uchar2uchar2", &ret);
        if (ret != CL_SUCCESS)
        {
