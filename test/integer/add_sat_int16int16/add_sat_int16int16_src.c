...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'add_sat_int16int16.cl' */
        source_code = read_buffer("add_sat_int16int16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "add_sat_int16int16", &ret);
        if (ret != CL_SUCCESS)
        {
