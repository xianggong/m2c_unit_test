...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'min_ushort4ushort4.cl' */
        source_code = read_buffer("min_ushort4ushort4.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "min_ushort4ushort4", &ret);
        if (ret != CL_SUCCESS)
        {
