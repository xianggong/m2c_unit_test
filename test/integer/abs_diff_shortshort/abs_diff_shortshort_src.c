...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'abs_diff_shortshort.cl' */
        source_code = read_buffer("abs_diff_shortshort.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "abs_diff_shortshort", &ret);
        if (ret != CL_SUCCESS)
        {
