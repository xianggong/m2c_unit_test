...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'rotate_ushort16ushort16.cl' */
        source_code = read_buffer("rotate_ushort16ushort16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "rotate_ushort16ushort16", &ret);
        if (ret != CL_SUCCESS)
        {
