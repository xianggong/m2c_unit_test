...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'add_sat_char8char8.cl' */
        source_code = read_buffer("add_sat_char8char8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "add_sat_char8char8", &ret);
        if (ret != CL_SUCCESS)
        {
