...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'rhadd_ulong8ulong8.cl' */
        source_code = read_buffer("rhadd_ulong8ulong8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "rhadd_ulong8ulong8", &ret);
        if (ret != CL_SUCCESS)
        {
