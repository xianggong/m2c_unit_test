...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'mul_hi_char16char16.cl' */
        source_code = read_buffer("mul_hi_char16char16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "mul_hi_char16char16", &ret);
        if (ret != CL_SUCCESS)
        {
