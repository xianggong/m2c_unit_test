...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'abs_diff_uchar16uchar16.cl' */
        source_code = read_buffer("abs_diff_uchar16uchar16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "abs_diff_uchar16uchar16", &ret);
        if (ret != CL_SUCCESS)
        {
