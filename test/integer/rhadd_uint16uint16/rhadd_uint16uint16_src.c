...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'rhadd_uint16uint16.cl' */
        source_code = read_buffer("rhadd_uint16uint16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "rhadd_uint16uint16", &ret);
        if (ret != CL_SUCCESS)
        {
