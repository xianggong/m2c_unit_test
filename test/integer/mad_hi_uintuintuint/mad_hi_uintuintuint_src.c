...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'mad_hi_uintuintuint.cl' */
        source_code = read_buffer("mad_hi_uintuintuint.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "mad_hi_uintuintuint", &ret);
        if (ret != CL_SUCCESS)
        {
