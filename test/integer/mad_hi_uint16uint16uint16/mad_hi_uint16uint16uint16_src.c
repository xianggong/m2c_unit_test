...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'mad_hi_uint16uint16uint16.cl' */
        source_code = read_buffer("mad_hi_uint16uint16uint16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "mad_hi_uint16uint16uint16", &ret);
        if (ret != CL_SUCCESS)
        {
