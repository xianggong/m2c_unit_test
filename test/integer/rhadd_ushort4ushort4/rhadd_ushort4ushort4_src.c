...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'rhadd_ushort4ushort4.cl' */
        source_code = read_buffer("rhadd_ushort4ushort4.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "rhadd_ushort4ushort4", &ret);
        if (ret != CL_SUCCESS)
        {
