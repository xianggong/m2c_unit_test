...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'hadd_ulong16ulong16.cl' */
        source_code = read_buffer("hadd_ulong16ulong16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "hadd_ulong16ulong16", &ret);
        if (ret != CL_SUCCESS)
        {
