...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'rhadd_uchar4uchar4.cl' */
        source_code = read_buffer("rhadd_uchar4uchar4.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "rhadd_uchar4uchar4", &ret);
        if (ret != CL_SUCCESS)
        {
