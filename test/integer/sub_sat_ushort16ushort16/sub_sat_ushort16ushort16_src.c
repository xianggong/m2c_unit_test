...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'sub_sat_ushort16ushort16.cl' */
        source_code = read_buffer("sub_sat_ushort16ushort16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "sub_sat_ushort16ushort16", &ret);
        if (ret != CL_SUCCESS)
        {
