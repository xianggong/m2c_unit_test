...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'mad_hi_ulong8ulong8ulong8.cl' */
        source_code = read_buffer("mad_hi_ulong8ulong8ulong8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "mad_hi_ulong8ulong8ulong8", &ret);
        if (ret != CL_SUCCESS)
        {
