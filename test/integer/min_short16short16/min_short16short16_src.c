...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'min_short16short16.cl' */
        source_code = read_buffer("min_short16short16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "min_short16short16", &ret);
        if (ret != CL_SUCCESS)
        {
