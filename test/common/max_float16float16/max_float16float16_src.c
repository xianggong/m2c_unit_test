...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'max_float16float16.cl' */
        source_code = read_buffer("max_float16float16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "max_float16float16", &ret);
        if (ret != CL_SUCCESS)
        {
