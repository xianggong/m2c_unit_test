...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'clamp_float2float2float2.cl' */
        source_code = read_buffer("clamp_float2float2float2.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "clamp_float2float2float2", &ret);
        if (ret != CL_SUCCESS)
        {
