...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'mix_floatfloatfloat.cl' */
        source_code = read_buffer("mix_floatfloatfloat.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "mix_floatfloatfloat", &ret);
        if (ret != CL_SUCCESS)
        {
