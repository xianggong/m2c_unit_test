...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'mix_float8float8float8.cl' */
        source_code = read_buffer("mix_float8float8float8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "mix_float8float8float8", &ret);
        if (ret != CL_SUCCESS)
        {
