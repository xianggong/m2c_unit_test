...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'clamp_floatfloatfloat.cl' */
        source_code = read_buffer("clamp_floatfloatfloat.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "clamp_floatfloatfloat", &ret);
        if (ret != CL_SUCCESS)
        {
