...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'native_divide_float.cl' */
        source_code = read_buffer("native_divide_float.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "native_divide_float", &ret);
        if (ret != CL_SUCCESS)
        {
