...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'fmax_float16float16.cl' */
        source_code = read_buffer("fmax_float16float16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "fmax_float16float16", &ret);
        if (ret != CL_SUCCESS)
        {
