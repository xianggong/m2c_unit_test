...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'copysign_float8float8.cl' */
        source_code = read_buffer("copysign_float8float8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "copysign_float8float8", &ret);
        if (ret != CL_SUCCESS)
        {
