...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'half_powr_floatfloat.cl' */
        source_code = read_buffer("half_powr_floatfloat.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "half_powr_floatfloat", &ret);
        if (ret != CL_SUCCESS)
        {
