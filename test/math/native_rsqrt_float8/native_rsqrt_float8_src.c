...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'native_rsqrt_float8.cl' */
        source_code = read_buffer("native_rsqrt_float8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "native_rsqrt_float8", &ret);
        if (ret != CL_SUCCESS)
        {
