...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'fma_floatfloatfloat.cl' */
        source_code = read_buffer("fma_floatfloatfloat.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "fma_floatfloatfloat", &ret);
        if (ret != CL_SUCCESS)
        {
