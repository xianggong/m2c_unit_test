...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'native_log_float16.cl' */
        source_code = read_buffer("native_log_float16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "native_log_float16", &ret);
        if (ret != CL_SUCCESS)
        {
