...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'copysign_floatfloat.cl' */
        source_code = read_buffer("copysign_floatfloat.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "copysign_floatfloat", &ret);
        if (ret != CL_SUCCESS)
        {
