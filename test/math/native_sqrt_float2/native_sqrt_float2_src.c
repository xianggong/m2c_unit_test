...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'native_sqrt_float2.cl' */
        source_code = read_buffer("native_sqrt_float2.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "native_sqrt_float2", &ret);
        if (ret != CL_SUCCESS)
        {
