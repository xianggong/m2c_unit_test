...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'native_exp2_float4.cl' */
        source_code = read_buffer("native_exp2_float4.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "native_exp2_float4", &ret);
        if (ret != CL_SUCCESS)
        {
