...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'atan2pi_floatfloat.cl' */
        source_code = read_buffer("atan2pi_floatfloat.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "atan2pi_floatfloat", &ret);
        if (ret != CL_SUCCESS)
        {
