...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'mad_floatfloatfloat.cl' */
        source_code = read_buffer("mad_floatfloatfloat.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "mad_floatfloatfloat", &ret);
        if (ret != CL_SUCCESS)
        {
