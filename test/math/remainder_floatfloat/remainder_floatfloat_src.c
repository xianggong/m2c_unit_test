...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'remainder_floatfloat.cl' */
        source_code = read_buffer("remainder_floatfloat.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "remainder_floatfloat", &ret);
        if (ret != CL_SUCCESS)
        {
