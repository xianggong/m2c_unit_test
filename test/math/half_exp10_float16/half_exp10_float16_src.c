...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'half_exp10_float16.cl' */
        source_code = read_buffer("half_exp10_float16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "half_exp10_float16", &ret);
        if (ret != CL_SUCCESS)
        {
