...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'rootn_float16int16.cl' */
        source_code = read_buffer("rootn_float16int16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "rootn_float16int16", &ret);
        if (ret != CL_SUCCESS)
        {
