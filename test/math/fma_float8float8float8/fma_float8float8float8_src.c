...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'fma_float8float8float8.cl' */
        source_code = read_buffer("fma_float8float8float8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "fma_float8float8float8", &ret);
        if (ret != CL_SUCCESS)
        {
