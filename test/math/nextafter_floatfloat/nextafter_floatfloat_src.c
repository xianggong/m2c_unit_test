...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'nextafter_floatfloat.cl' */
        source_code = read_buffer("nextafter_floatfloat.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "nextafter_floatfloat", &ret);
        if (ret != CL_SUCCESS)
        {
