...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'equal_ulong8ulong8.cl' */
        source_code = read_buffer("equal_ulong8ulong8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "equal_ulong8ulong8", &ret);
        if (ret != CL_SUCCESS)
        {
