...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'multiply_ulongulong.cl' */
        source_code = read_buffer("multiply_ulongulong.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "multiply_ulongulong", &ret);
        if (ret != CL_SUCCESS)
        {
