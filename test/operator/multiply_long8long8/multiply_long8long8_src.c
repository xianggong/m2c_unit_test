...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'multiply_long8long8.cl' */
        source_code = read_buffer("multiply_long8long8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "multiply_long8long8", &ret);
        if (ret != CL_SUCCESS)
        {
