...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'not_equal_shortshort.cl' */
        source_code = read_buffer("not_equal_shortshort.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "not_equal_shortshort", &ret);
        if (ret != CL_SUCCESS)
        {
