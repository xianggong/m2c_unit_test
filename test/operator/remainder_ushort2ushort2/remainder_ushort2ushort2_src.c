...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'remainder_ushort2ushort2.cl' */
        source_code = read_buffer("remainder_ushort2ushort2.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "remainder_ushort2ushort2", &ret);
        if (ret != CL_SUCCESS)
        {
