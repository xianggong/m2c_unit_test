...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'remainder_ucharuchar.cl' */
        source_code = read_buffer("remainder_ucharuchar.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "remainder_ucharuchar", &ret);
        if (ret != CL_SUCCESS)
        {
