...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'multiply_ucharuchar.cl' */
        source_code = read_buffer("multiply_ucharuchar.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "multiply_ucharuchar", &ret);
        if (ret != CL_SUCCESS)
        {
