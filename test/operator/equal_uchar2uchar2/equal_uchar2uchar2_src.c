...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'equal_uchar2uchar2.cl' */
        source_code = read_buffer("equal_uchar2uchar2.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "equal_uchar2uchar2", &ret);
        if (ret != CL_SUCCESS)
        {
