...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'relational_less_than_or_equal_to_ulongulong.cl' */
        source_code = read_buffer("relational_less_than_or_equal_to_ulongulong.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "relational_less_than_or_equal_to_ulongulong", &ret);
        if (ret != CL_SUCCESS)
        {
