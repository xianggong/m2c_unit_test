...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'subtract_ulongulong.cl' */
        source_code = read_buffer("subtract_ulongulong.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "subtract_ulongulong", &ret);
        if (ret != CL_SUCCESS)
        {
