...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'multiply_shortshort.cl' */
        source_code = read_buffer("multiply_shortshort.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "multiply_shortshort", &ret);
        if (ret != CL_SUCCESS)
        {
