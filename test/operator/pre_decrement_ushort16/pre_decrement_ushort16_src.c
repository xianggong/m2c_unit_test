...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'pre_decrement_ushort16.cl' */
        source_code = read_buffer("pre_decrement_ushort16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "pre_decrement_ushort16", &ret);
        if (ret != CL_SUCCESS)
        {
