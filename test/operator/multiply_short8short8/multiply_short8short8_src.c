...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'multiply_short8short8.cl' */
        source_code = read_buffer("multiply_short8short8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "multiply_short8short8", &ret);
        if (ret != CL_SUCCESS)
        {
