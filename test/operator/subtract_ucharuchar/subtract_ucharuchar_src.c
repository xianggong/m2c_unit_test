...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'subtract_ucharuchar.cl' */
        source_code = read_buffer("subtract_ucharuchar.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "subtract_ucharuchar", &ret);
        if (ret != CL_SUCCESS)
        {
