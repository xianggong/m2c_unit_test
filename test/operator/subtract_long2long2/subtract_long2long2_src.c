...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'subtract_long2long2.cl' */
        source_code = read_buffer("subtract_long2long2.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "subtract_long2long2", &ret);
        if (ret != CL_SUCCESS)
        {
