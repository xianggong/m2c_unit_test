...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'unary_plus_short16.cl' */
        source_code = read_buffer("unary_plus_short16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "unary_plus_short16", &ret);
        if (ret != CL_SUCCESS)
        {
