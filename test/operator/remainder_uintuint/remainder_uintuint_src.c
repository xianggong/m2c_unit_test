...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'remainder_uintuint.cl' */
        source_code = read_buffer("remainder_uintuint.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "remainder_uintuint", &ret);
        if (ret != CL_SUCCESS)
        {
