...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'relational_less_than_or_equal_to_int16int16.cl' */
        source_code = read_buffer("relational_less_than_or_equal_to_int16int16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "relational_less_than_or_equal_to_int16int16", &ret);
        if (ret != CL_SUCCESS)
        {
