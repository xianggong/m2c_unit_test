...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'add_ulong16ulong16.cl' */
        source_code = read_buffer("add_ulong16ulong16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "add_ulong16ulong16", &ret);
        if (ret != CL_SUCCESS)
        {
