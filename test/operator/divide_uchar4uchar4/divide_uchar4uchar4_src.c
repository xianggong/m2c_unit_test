...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'divide_uchar4uchar4.cl' */
        source_code = read_buffer("divide_uchar4uchar4.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "divide_uchar4uchar4", &ret);
        if (ret != CL_SUCCESS)
        {
