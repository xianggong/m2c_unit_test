...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'remainder_long8long8.cl' */
        source_code = read_buffer("remainder_long8long8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "remainder_long8long8", &ret);
        if (ret != CL_SUCCESS)
        {
