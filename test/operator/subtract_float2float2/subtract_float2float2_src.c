...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'subtract_float2float2.cl' */
        source_code = read_buffer("subtract_float2float2.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "subtract_float2float2", &ret);
        if (ret != CL_SUCCESS)
        {
