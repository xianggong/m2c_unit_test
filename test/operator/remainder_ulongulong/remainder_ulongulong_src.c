...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'remainder_ulongulong.cl' */
        source_code = read_buffer("remainder_ulongulong.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "remainder_ulongulong", &ret);
        if (ret != CL_SUCCESS)
        {
