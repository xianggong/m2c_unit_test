...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'pre_increment_float4.cl' */
        source_code = read_buffer("pre_increment_float4.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "pre_increment_float4", &ret);
        if (ret != CL_SUCCESS)
        {
