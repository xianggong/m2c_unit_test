...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'pre_increment_ulong.cl' */
        source_code = read_buffer("pre_increment_ulong.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "pre_increment_ulong", &ret);
        if (ret != CL_SUCCESS)
        {
