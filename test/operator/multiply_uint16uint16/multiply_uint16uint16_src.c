...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'multiply_uint16uint16.cl' */
        source_code = read_buffer("multiply_uint16uint16.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "multiply_uint16uint16", &ret);
        if (ret != CL_SUCCESS)
        {
