...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'relational_greater_than_int4int4.cl' */
        source_code = read_buffer("relational_greater_than_int4int4.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "relational_greater_than_int4int4", &ret);
        if (ret != CL_SUCCESS)
        {
