...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'post_increment_ushort8.cl' */
        source_code = read_buffer("post_increment_ushort8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "post_increment_ushort8", &ret);
        if (ret != CL_SUCCESS)
        {
