...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'relational_greater_than_or_equal_to_long8long8.cl' */
        source_code = read_buffer("relational_greater_than_or_equal_to_long8long8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "relational_greater_than_or_equal_to_long8long8", &ret);
        if (ret != CL_SUCCESS)
        {
