...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'divide_ushortushort.cl' */
        source_code = read_buffer("divide_ushortushort.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "divide_ushortushort", &ret);
        if (ret != CL_SUCCESS)
        {
