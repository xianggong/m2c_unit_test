...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'pre_decrement_char8.cl' */
        source_code = read_buffer("pre_decrement_char8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "pre_decrement_char8", &ret);
        if (ret != CL_SUCCESS)
        {
