...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'equal_ulong4ulong4.cl' */
        source_code = read_buffer("equal_ulong4ulong4.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "equal_ulong4ulong4", &ret);
        if (ret != CL_SUCCESS)
        {
