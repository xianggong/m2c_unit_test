...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'subtract_shortshort.cl' */
        source_code = read_buffer("subtract_shortshort.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "subtract_shortshort", &ret);
        if (ret != CL_SUCCESS)
        {
