...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'not_equal_char2char2.cl' */
        source_code = read_buffer("not_equal_char2char2.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "not_equal_char2char2", &ret);
        if (ret != CL_SUCCESS)
        {
