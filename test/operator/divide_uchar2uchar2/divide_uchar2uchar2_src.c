...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'divide_uchar2uchar2.cl' */
        source_code = read_buffer("divide_uchar2uchar2.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "divide_uchar2uchar2", &ret);
        if (ret != CL_SUCCESS)
        {
