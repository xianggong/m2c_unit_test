...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'remainder_shortshort.cl' */
        source_code = read_buffer("remainder_shortshort.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "remainder_shortshort", &ret);
        if (ret != CL_SUCCESS)
        {
