...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'multiply_float2float2.cl' */
        source_code = read_buffer("multiply_float2float2.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "multiply_float2float2", &ret);
        if (ret != CL_SUCCESS)
        {
