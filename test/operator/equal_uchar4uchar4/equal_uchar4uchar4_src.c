...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'equal_uchar4uchar4.cl' */
        source_code = read_buffer("equal_uchar4uchar4.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "equal_uchar4uchar4", &ret);
        if (ret != CL_SUCCESS)
        {
