...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'equal_float8float8.cl' */
        source_code = read_buffer("equal_float8float8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "equal_float8float8", &ret);
        if (ret != CL_SUCCESS)
        {
