...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'subtract_short8short8.cl' */
        source_code = read_buffer("subtract_short8short8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "subtract_short8short8", &ret);
        if (ret != CL_SUCCESS)
        {
