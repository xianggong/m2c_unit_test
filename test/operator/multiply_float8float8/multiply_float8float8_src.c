...
int main(int argc, char const *argv[])
{
        ...
        /* Read program from 'multiply_float8float8.cl' */
        source_code = read_buffer("multiply_float8float8.cl", &source_length);
        ...
        cl_kernel kernel;
        kernel = clCreateKernel(program, "multiply_float8float8", &ret);
        if (ret != CL_SUCCESS)
        {
