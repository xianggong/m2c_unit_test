.global workitem_get_global_id_0
...
entry:
	v_mov_b32 v7, s22
	v_mul_i32_i24 v9, 0x4, v3
	v_add_i32 v8, vcc, v9, v7
	tbuffer_store_format_x v3, v8, s[24:27], 0x0 offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	s_waitcnt expcnt(0)
	s_endpgm 
