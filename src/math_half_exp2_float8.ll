...
define void @math_half_exp2_float8(<8 x float> addrspace(1)* %src_0) #0 {
  ...
  %tmp_5 = call i32 bitcast (i32 (...)* @half_exp2 to i32 (<8 x float>)*)(<8 x float> %tmp_4)
...
!0 = metadata !{void (<8 x float> addrspace(1)*)* @math_half_exp2_float8}
