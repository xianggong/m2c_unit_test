; ModuleID = 'integer_abs_sat_ushortushort.cl'
target datalayout = "e-p:64:64:64-p3:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024-v2048:2048:2048-n32:64"
target triple = "r600--"

; Function Attrs: nounwind
define void @integer_abs_sat_ushortushort(i16 addrspace(1)* %src_0, i16 addrspace(1)* %src_1) #0 {
  ...
  %tmp_10 = zext i16 %tmp_9 to i32
  %tmp_11 = call i32 bitcast (i32 (...)* @abs_sat to i32 (i32, i32)*)(i32 %tmp_6, i32 %tmp_10)
  %tmp_12 = trunc i32 %tmp_11 to i16
  store i16 %tmp_12, i16* %val, align 2
  ret void
}
...
!0 = metadata !{void (i16 addrspace(1)*, i16 addrspace(1)*)* @integer_abs_sat_ushortushort}
