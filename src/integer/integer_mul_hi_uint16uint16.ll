; ModuleID = 'integer_mul_hi_uint16uint16.cl'
target datalayout = "e-p:64:64:64-p3:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024-v2048:2048:2048-n32:64"
target triple = "r600--"

; Function Attrs: nounwind
define void @integer_mul_hi_uint16uint16(<16 x i32> addrspace(1)* %src_0, <16 x i32> addrspace(1)* %src_1, <16 x i32> addrspace(1)* %dst) #0 {
entry:
  ...
  %tmp_13 = call <16 x i32> @_Z6mul_hiDv16_jS_(<16 x i32> %tmp_8, <16 x i32> %tmp_12)
...
!0 = metadata !{void (<16 x i32> addrspace(1)*, <16 x i32> addrspace(1)*, <16 x i32> addrspace(1)*)* @integer_mul_hi_uint16uint16}
