...
define void @integer_mad_sat_uchar4uchar4uchar4(<4 x i8> addrspace(1)* %src_0, <4 x i8> addrspace(1)* %src_1, <4 x i8> addrspace(1)* %src_2, <4 x i8> addrspace(1)* %dst) #0 {
  ...
  %tmp_15 = call <4 x i8> @_Z7mad_satDv4_hS_S_(<4 x i8> %tmp_8, <4 x i8> %tmp_11, <4 x i8> %tmp_14)
...
!0 = metadata !{void (<4 x i8> addrspace(1)*, <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)*)* @integer_mad_sat_uchar4uchar4uchar4}
