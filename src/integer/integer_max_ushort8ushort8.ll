...
define void @integer_max_ushort8ushort8(<8 x i16> addrspace(1)* %src_0, <8 x i16> addrspace(1)* %src_1, <8 x i16> addrspace(1)* %dst) #0 {
  ...
  %tmp_11 = call <8 x i16> @_Z3maxDv8_tS_(<8 x i16> %tmp_7, <8 x i16> %tmp_10)
...
!0 = metadata !{void (<8 x i16> addrspace(1)*, <8 x i16> addrspace(1)*, <8 x i16> addrspace(1)*)* @integer_max_ushort8ushort8}
