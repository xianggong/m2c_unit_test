; ModuleID = 'integer_clz_ushort16.cl'
...
define void @integer_clz_ushort16(<16 x i16> addrspace(1)* %src_0, <16 x i16> addrspace(1)* %dst) #0 {
  ...
  %tmp_8 = call <16 x i16> @_Z3clzDv16_t(<16 x i16> %tmp_7)
...
declare <16 x i16> @_Z3clzDv16_t(<16 x i16>) #1
...
!0 = metadata !{void (<16 x i16> addrspace(1)*, <16 x i16> addrspace(1)*)* @integer_clz_ushort16}
