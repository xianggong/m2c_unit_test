...
define void @integer_hadd_short8short8(<8 x i16> addrspace(1)* %src_0, <8 x i16> addrspace(1)* %src_1, <8 x i16> addrspace(1)* %dst) #0 {
  ...
  %tmp_11 = call <8 x i16> @_Z4haddDv8_sS_(<8 x i16> %tmp_7, <8 x i16> %tmp_10)
...
!0 = metadata !{void (<8 x i16> addrspace(1)*, <8 x i16> addrspace(1)*, <8 x i16> addrspace(1)*)* @integer_hadd_short8short8}
