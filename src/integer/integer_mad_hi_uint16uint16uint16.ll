...
define void @integer_mad_hi_uint16uint16uint16(<16 x i32> addrspace(1)* %src_0, <16 x i32> addrspace(1)* %src_1, <16 x i32> addrspace(1)* %src_2, <16 x i32> addrspace(1)* %dst) #0 {
  ...
  %tmp_14 = getelementptr inbounds <16 x i32> addrspace(1)* %tmp_13, i32 0
  %tmp_15 = load <16 x i32> addrspace(1)* %tmp_14, align 64
  %tmp_16 = add <16 x i32> %tmp_12, %tmp_15
  %tmp_17 = load i32* %gid, align 4
  %tmp_18 = load <16 x i32> addrspace(1)** %tmp_4, align 4
  %tmp_19 = getelementptr inbounds <16 x i32> addrspace(1)* %tmp_18, i32 %tmp_17
