; ModuleID = 'integer_mad_hi_ushortushortushort.cl'
target datalayout = "e-p:64:64:64-p3:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024-v2048:2048:2048-n32:64"
target triple = "r600--"

; Function Attrs: nounwind
define void @integer_mad_hi_ushortushortushort(i16 addrspace(1)* %src_0, i16 addrspace(1)* %src_1, i16 addrspace(1)* %src_2, i16 addrspace(1)* %dst) #0 {
entry:
  ...
  %tmp_14 = call zeroext i16 @_Z6mul_hitt(i16 zeroext %tmp_9, i16 zeroext %tmp_13)
  %tmp_15 = zext i16 %tmp_14 to i32
  %tmp_16 = load i32* %gid, align 4
  %tmp_17 = load i16 addrspace(1)** %tmp_3, align 4
  %tmp_18 = getelementptr inbounds i16 addrspace(1)* %tmp_17, i32 %tmp_16
  %tmp_19 = load i16 addrspace(1)* %tmp_18, align 2
  %tmp_20 = zext i16 %tmp_19 to i32
  %tmp_21 = add nsw i32 %tmp_15, %tmp_20
  %tmp_22 = trunc i32 %tmp_21 to i16
  %tmp_23 = load i32* %gid, align 4
  %tmp_24 = load i16 addrspace(1)** %tmp_4, align 4
  %tmp_25 = getelementptr inbounds i16 addrspace(1)* %tmp_24, i32 %tmp_23
  store i16 %tmp_22, i16 addrspace(1)* %tmp_25, align 2
  ret void
}

declare i32 @__get_global_id_u32(i32) #1

declare zeroext i16 @_Z6mul_hitt(i16 zeroext, i16 zeroext) #1
...
!0 = metadata !{void (i16 addrspace(1)*, i16 addrspace(1)*, i16 addrspace(1)*, i16 addrspace(1)*)* @integer_mad_hi_ushortushortushort}
