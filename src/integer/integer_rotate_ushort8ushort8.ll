...
define void @integer_rotate_ushort8ushort8(<8 x i16> addrspace(1)* %src_0, <8 x i16> addrspace(1)* %src_1, <8 x i16> addrspace(1)* %dst) #0 {
entry:
  ...
  %tmp_13 = call <8 x i16> @_Z6rotateDv8_tS_(<8 x i16> %tmp_8, <8 x i16> %tmp_12)
...
!0 = metadata !{void (<8 x i16> addrspace(1)*, <8 x i16> addrspace(1)*, <8 x i16> addrspace(1)*)* @integer_rotate_ushort8ushort8}
