...
define void @integer_mad_hi_uintuintuint(i32 addrspace(1)* %src_0, i32 addrspace(1)* %src_1, i32 addrspace(1)* %src_2, i32 addrspace(1)* %dst) #0 {
  ...
  %tmp_12 = call i32 @_Z6mul_hijj(i32 %tmp_8, i32 %tmp_11)
  %tmp_13 = load i32 addrspace(1)** %tmp_3, align 4
  %tmp_14 = getelementptr inbounds i32 addrspace(1)* %tmp_13, i32 0
  %tmp_15 = load i32 addrspace(1)* %tmp_14, align 4
  %tmp_16 = add i32 %tmp_12, %tmp_15
  %tmp_17 = load i32* %gid, align 4
  %tmp_18 = load i32 addrspace(1)** %tmp_4, align 4
...
!0 = metadata !{void (i32 addrspace(1)*, i32 addrspace(1)*, i32 addrspace(1)*, i32 addrspace(1)*)* @integer_mad_hi_uintuintuint}
