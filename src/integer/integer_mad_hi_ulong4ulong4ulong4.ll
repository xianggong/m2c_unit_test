...
define void @integer_mad_hi_ulong4ulong4ulong4(<4 x i64> addrspace(1)* %src_0, <4 x i64> addrspace(1)* %src_1, <4 x i64> addrspace(1)* %src_2, <4 x i64> addrspace(1)* %dst) #0 {
  ...
  %tmp_13 = load <4 x i64> addrspace(1)** %tmp_3, align 4
  %tmp_14 = getelementptr inbounds <4 x i64> addrspace(1)* %tmp_13, i32 0
  %tmp_15 = load <4 x i64> addrspace(1)* %tmp_14, align 32
  %tmp_16 = add <4 x i64> %tmp_12, %tmp_15
  %tmp_17 = load i32* %gid, align 4
  %tmp_18 = load <4 x i64> addrspace(1)** %tmp_4, align 4
  %tmp_19 = getelementptr inbounds <4 x i64> addrspace(1)* %tmp_18, i32 %tmp_17
