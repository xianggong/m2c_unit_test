...
define void @integer_rhadd_uint2uint2(<2 x i32> addrspace(1)* %src_0, <2 x i32> addrspace(1)* %src_1, <2 x i32> addrspace(1)* %dst) #0 {
  ...
  %tmp_11 = call <2 x i32> @_Z5rhaddDv2_jS_(<2 x i32> %tmp_7, <2 x i32> %tmp_10)
...
!0 = metadata !{void (<2 x i32> addrspace(1)*, <2 x i32> addrspace(1)*, <2 x i32> addrspace(1)*)* @integer_rhadd_uint2uint2}
