; ModuleID = 'relational_islessequal_float16float16.opt.bc'
...
!0 = metadata !{void (<16 x float> addrspace(1)*, <16 x float> addrspace(1)*, <16 x i32> addrspace(1)*)* @relational_islessequal_float16float16}
