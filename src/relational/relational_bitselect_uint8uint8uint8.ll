...
define void @relational_bitselect_uint8uint8uint8(<8 x i32> addrspace(1)* %src_0, <8 x i32> addrspace(1)* %src_1, <8 x i32> addrspace(1)* %src_2, <8 x i32> addrspace(1)* %dst) #0 {
  ...
  %tmp_12 = load <8 x i32> addrspace(1)** %tmp_3, align 4
  %tmp_13 = getelementptr inbounds <8 x i32> addrspace(1)* %tmp_12, i32 0
  ...
  %tmp_17 = load <8 x i32> addrspace(1)** %tmp_4, align 4
  %tmp_18 = getelementptr inbounds <8 x i32> addrspace(1)* %tmp_17, i32 %tmp_16
