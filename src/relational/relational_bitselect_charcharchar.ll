; ModuleID = 'relational_bitselect_charcharchar.cl'
target datalayout = "e-p:64:64:64-p3:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024-v2048:2048:2048-n32:64"
target triple = "r600--"

; Function Attrs: nounwind
define void @relational_bitselect_charcharchar(i8 addrspace(1)* %src_0, i8 addrspace(1)* %src_1, i8 addrspace(1)* %src_2, i8 addrspace(1)* %dst) #0 {
  ...
  %tmp_18 = call signext i8 @_Z9bitselectccc(i8 signext %tmp_9, i8 signext %tmp_13, i8 signext %tmp_17)
  %tmp_19 = load i32* %gid, align 4
  %tmp_20 = load i8 addrspace(1)** %tmp_4, align 4
  %tmp_21 = getelementptr inbounds i8 addrspace(1)* %tmp_20, i32 %tmp_19
...
!0 = metadata !{void (i8 addrspace(1)*, i8 addrspace(1)*, i8 addrspace(1)*, i8 addrspace(1)*)* @relational_bitselect_charcharchar}
