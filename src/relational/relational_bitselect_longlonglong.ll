; ModuleID = 'relational_bitselect_longlonglong.cl'
...
entry:
  ...
  %tmp_15 = load i64 addrspace(1)** %tmp_3, align 4
  %tmp_16 = getelementptr inbounds i64 addrspace(1)* %tmp_15, i32 %tmp_14
  ...
  %tmp_20 = load i64 addrspace(1)** %tmp_4, align 4
  %tmp_21 = getelementptr inbounds i64 addrspace(1)* %tmp_20, i32 %tmp_19
