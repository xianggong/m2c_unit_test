...
define void @relational_bitselect_longlonglong(i64 addrspace(1)* %src_0, i64 addrspace(1)* %src_1, i64 addrspace(1)* %src_2, i64 addrspace(1)* %dst) #0 {
  ...
  %tmp_12 = load i64 addrspace(1)** %tmp_3, align 4
  %tmp_13 = getelementptr inbounds i64 addrspace(1)* %tmp_12, i32 0
  %tmp_14 = load i64 addrspace(1)* %tmp_13, align 8
  %tmp_15 = call i64 @_Z9bitselectlll(i64 %tmp_8, i64 %tmp_11, i64 %tmp_14)
  %tmp_16 = load i32* %gid, align 4
  %tmp_17 = load i64 addrspace(1)** %tmp_4, align 4
  %tmp_18 = getelementptr inbounds i64 addrspace(1)* %tmp_17, i32 %tmp_16
