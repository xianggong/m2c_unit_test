; ModuleID = 'relational_islessequal_float2float2.cl'
target datalayout = "e-p:64:64:64-p3:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024-v2048:2048:2048-n32:64"
target triple = "r600--"

; Function Attrs: nounwind
define void @relational_islessequal_float2float2(<2 x float> addrspace(1)* %src_0, <2 x float> addrspace(1)* %src_1, <2 x i32> addrspace(1)* %dst) #0 {
  ...
  %tmp_11 = call <2 x i32> @_Z11islessequalDv2_fS_(<2 x float> %tmp_7, <2 x float> %tmp_10)
...
!0 = metadata !{void (<2 x float> addrspace(1)*, <2 x float> addrspace(1)*, <2 x i32> addrspace(1)*)* @relational_islessequal_float2float2}
