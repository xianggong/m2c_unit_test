...
define void @relational_bitselect_uintuintuint(i32 addrspace(1)* %src_0, i32 addrspace(1)* %src_1, i32 addrspace(1)* %src_2, i32 addrspace(1)* %dst) #0 {
  ...
  %tmp_7 = load i32 addrspace(1)** %tmp_1, align 4
  ...
  %tmp_17 = load i32 addrspace(1)* %tmp_16, align 4
  %tmp_18 = call i32 @_Z9bitselectjjj(i32 %tmp_9, i32 %tmp_13, i32 %tmp_17)
  %tmp_19 = load i32* %gid, align 4
  %tmp_20 = load i32 addrspace(1)** %tmp_4, align 4
  %tmp_21 = getelementptr inbounds i32 addrspace(1)* %tmp_20, i32 %tmp_19
  store i32 %tmp_18, i32 addrspace(1)* %tmp_21, align 4
  ret void
}
