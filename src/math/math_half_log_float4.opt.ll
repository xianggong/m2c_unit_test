...
define void @math_half_log_float4(<4 x float> addrspace(1)* %src_0, <4 x float> addrspace(1)* %dst) #0 {
  ...
  %tmp_8 = call i32 bitcast (i32 (...)* @half_log to i32 (<4 x float>)*)(<4 x float> %tmp_7)
...
!0 = metadata !{void (<4 x float> addrspace(1)*, <4 x float> addrspace(1)*)* @math_half_log_float4}
