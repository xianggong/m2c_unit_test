...
define void @math_lgamma_float(float addrspace(1)* %src_0, float addrspace(1)* %dst) #0 {
  ...
  %tmp_9 = call double @lgamma(double %tmp_8) #3
...
!0 = metadata !{void (float addrspace(1)*, float addrspace(1)*)* @math_lgamma_float}
