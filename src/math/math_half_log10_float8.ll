...
define void @math_half_log10_float8(<8 x float> addrspace(1)* %src_0, <8 x float> addrspace(1)* %dst) #0 {
entry:
  ...
  %tmp_8 = call i32 bitcast (i32 (...)* @half_log10 to i32 (<8 x float>)*)(<8 x float> %tmp_7)
...
!0 = metadata !{void (<8 x float> addrspace(1)*, <8 x float> addrspace(1)*)* @math_half_log10_float8}
