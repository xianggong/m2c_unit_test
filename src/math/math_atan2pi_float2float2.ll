...
define void @math_atan2pi_float2float2(<2 x float> addrspace(1)* %src_0, <2 x float> addrspace(1)* %src_1, <2 x float> addrspace(1)* %dst) #0 {
  ...
  %tmp_13 = call i32 bitcast (i32 (...)* @atan2pi to i32 (<2 x float>, <2 x float>)*)(<2 x float> %tmp_8, <2 x float> %tmp_12)
  ...
  %tmp_18 = load <2 x float> addrspace(1)** %tmp_3, align 4
  %tmp_19 = getelementptr inbounds <2 x float> addrspace(1)* %tmp_18, i32 %tmp_17
