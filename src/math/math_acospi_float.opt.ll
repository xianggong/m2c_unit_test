...
define void @math_acospi_float(float addrspace(1)* %src_0, float addrspace(1)* %dst) #0 {
  ...
  %tmp_9 = call i32 bitcast (i32 (...)* @acospi to i32 (double)*)(double %tmp_8)
...
!0 = metadata !{void (float addrspace(1)*, float addrspace(1)*)* @math_acospi_float}
