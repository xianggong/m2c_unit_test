...
define void @math_nan_uint(i32 addrspace(1)* %src_0, float addrspace(1)* %dst) #0 {
  ...
  %tmp_7 = inttoptr i32 %tmp_6 to i8*
  %tmp_8 = call double @nan(i8* %tmp_7) #3
...
!0 = metadata !{void (i32 addrspace(1)*, float addrspace(1)*)* @math_nan_uint}
