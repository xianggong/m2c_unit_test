...
define void @math_log_float8(<8 x float> addrspace(1)* %src_0, <8 x float> addrspace(1)* %dst) #0 {
...
!0 = metadata !{void (<8 x float> addrspace(1)*, <8 x float> addrspace(1)*)* @math_log_float8}
