...
define void @math_native_rsqrt_float4(<4 x float> addrspace(1)* %src_0, <4 x float> addrspace(1)* %dst) #0 {
  ...
  %tmp_7 = call i32 bitcast (i32 (...)* @native_rsqrt to i32 (<4 x float>)*)(<4 x float> %tmp_6)
...
!0 = metadata !{void (<4 x float> addrspace(1)*, <4 x float> addrspace(1)*)* @math_native_rsqrt_float4}
