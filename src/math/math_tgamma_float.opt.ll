...
define void @math_tgamma_float(float addrspace(1)* %src_0, float addrspace(1)* %dst) #0 {
  ...
  %tmp_8 = call double @tgamma(double %tmp_7) #3
...
!0 = metadata !{void (float addrspace(1)*, float addrspace(1)*)* @math_tgamma_float}
