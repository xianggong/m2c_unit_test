...
define void @math_cbrt_float(float addrspace(1)* %src_0, float addrspace(1)* %dst) #0 {
entry:
  ...
  %tmp_9 = call double @cbrt(double %tmp_8) #3
...
!0 = metadata !{void (float addrspace(1)*, float addrspace(1)*)* @math_cbrt_float}
