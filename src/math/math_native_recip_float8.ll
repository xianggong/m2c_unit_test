...
define void @math_native_recip_float8(<8 x float> addrspace(1)* %src_0, <8 x float> addrspace(1)* %dst) #0 {
entry:
  ...
  %tmp_8 = call i32 bitcast (i32 (...)* @native_recip to i32 (<8 x float>)*)(<8 x float> %tmp_7)
  ...
  %tmp_13 = load <8 x float> addrspace(1)** %tmp_2, align 4
...
!0 = metadata !{void (<8 x float> addrspace(1)*, <8 x float> addrspace(1)*)* @math_native_recip_float8}
