...
define void @math_half_divide_float2float2(<2 x float> addrspace(1)* %src_0, <2 x float> addrspace(1)* %src_1, <2 x float> addrspace(1)* %dst) #0 {
  ...
  %tmp_11 = call i32 bitcast (i32 (...)* @half_divide to i32 (<2 x float>, <2 x float>)*)(<2 x float> %tmp_7, <2 x float> %tmp_10)
...
!0 = metadata !{void (<2 x float> addrspace(1)*, <2 x float> addrspace(1)*, <2 x float> addrspace(1)*)* @math_half_divide_float2float2}
