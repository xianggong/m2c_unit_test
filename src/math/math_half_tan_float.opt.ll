...
define void @math_half_tan_float(float addrspace(1)* %src_0, float addrspace(1)* %dst) #0 {
  ...
  %tmp_8 = call i32 bitcast (i32 (...)* @half_tan to i32 (double)*)(double %tmp_7)
...
!0 = metadata !{void (float addrspace(1)*, float addrspace(1)*)* @math_half_tan_float}
