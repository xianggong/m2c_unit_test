...
define void @math_erf_float(float addrspace(1)* %src_0, float addrspace(1)* %dst) #0 {
  ...
  %tmp_8 = call double @erf(double %tmp_7) #3
...
!0 = metadata !{void (float addrspace(1)*, float addrspace(1)*)* @math_erf_float}
