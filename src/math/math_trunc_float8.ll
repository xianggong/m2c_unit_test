...
define void @math_trunc_float8(<8 x float> addrspace(1)* %src_0, <8 x float> addrspace(1)* %dst) #0 {
  ...
  %tmp_7 = call <8 x float> @llvm.trunc.v8f32(<8 x float> %tmp_6)
...
!0 = metadata !{void (<8 x float> addrspace(1)*, <8 x float> addrspace(1)*)* @math_trunc_float8}
