...
define void @math_native_recip_float(float addrspace(1)* %src_0, float addrspace(1)* %dst) #0 {
entry:
  ...
  %tmp_9 = call i32 bitcast (i32 (...)* @native_recip to i32 (double)*)(double %tmp_8)
...
!0 = metadata !{void (float addrspace(1)*, float addrspace(1)*)* @math_native_recip_float}
