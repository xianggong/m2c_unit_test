...
define void @math_atan2pi_float16float16(<16 x float> addrspace(1)* %src_0, <16 x float> addrspace(1)* %src_1, <16 x float> addrspace(1)* %dst) #0 {
  ...
  %tmp_11 = call i32 bitcast (i32 (...)* @atan2pi to i32 (<16 x float>, <16 x float>)*)(<16 x float> %tmp_7, <16 x float> %tmp_10)
  ...
  %tmp_17 = getelementptr inbounds <16 x float> addrspace(1)* %dst, i32 %tmp_4
