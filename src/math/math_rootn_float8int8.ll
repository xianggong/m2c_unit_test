...
define void @math_rootn_float8int8(<8 x float> addrspace(1)* %src_0, <8 x i32> addrspace(1)* %src_1, <8 x float> addrspace(1)* %dst) #0 {
  ...
  %tmp_11 = call i32 bitcast (i32 (...)* @rootn to i32 (<8 x float>, <8 x i32>)*)(<8 x float> %tmp_7, <8 x i32> %tmp_10)
  ...
  %tmp_16 = load <8 x float> addrspace(1)** %tmp_3, align 4
  %tmp_17 = getelementptr inbounds <8 x float> addrspace(1)* %tmp_16, i32 %tmp_15
