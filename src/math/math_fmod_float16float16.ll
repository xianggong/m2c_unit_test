...
define void @math_fmod_float16float16(<16 x float> addrspace(1)* %src_0, <16 x float> addrspace(1)* %src_1, <16 x float> addrspace(1)* %dst) #0 {
  ...
  %tmp_11 = call <16 x float> @_Z4fmodDv16_fS_(<16 x float> %tmp_7, <16 x float> %tmp_10)
...
!0 = metadata !{void (<16 x float> addrspace(1)*, <16 x float> addrspace(1)*, <16 x float> addrspace(1)*)* @math_fmod_float16float16}
