.global operator_post_decrement_uint
...
:
	...
	s_waitcnt vmcnt(0)
	v_mov_b32 v12, 0xffffffff
	v_add_i32 v13, vcc, v11, v12
	tbuffer_store_format_x v13, v9, s[24:27], 0x0 offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	s_waitcnt expcnt(0)
	v_mov_b32 v14, s28
	v_mul_i32_i24 v16, 0x4, v3
	v_add_i32 v15, vcc, v16, v14
	tbuffer_store_format_x v11, v15, s[32:35], 0x0 offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	s_waitcnt expcnt(0)
	s_endpgm 
