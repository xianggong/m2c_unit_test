.global operator_divide_floatfloat
...
entry:
	...
	s_waitcnt vmcnt(0)
	v_rcp_f32 v18, v16
	v_mul_f32 v17, v12, v18
	v_mov_b32 v19, s36
	v_mul_i32_i24 v21, 0x4, v3
	v_add_i32 v20, vcc, v21, v19
	tbuffer_store_format_x v17, v20, s[40:43], 0x0 offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	s_waitcnt expcnt(0)
	s_endpgm 
