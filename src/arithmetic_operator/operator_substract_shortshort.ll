; ModuleID = 'operator_substract_shortshort.cl'
target datalayout = "e-p:64:64:64-p3:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024-v2048:2048:2048-n32:64"
target triple = "r600--"

; Function Attrs: nounwind
define void @operator_substract_shortshort(i16 addrspace(1)* %src_0, i16 addrspace(1)* %src_1, i16 addrspace(1)* %dst) #0 {
  ...
  %tmp_14 = sext i16 %tmp_13 to i32
  %tmp_15 = sub nsw i32 %tmp_9, %tmp_14
  %tmp_16 = trunc i32 %tmp_15 to i16
  %tmp_17 = load i32* %gid, align 4
  %tmp_18 = load i16 addrspace(1)** %tmp_3, align 4
  %tmp_19 = getelementptr inbounds i16 addrspace(1)* %tmp_18, i32 %tmp_17
...
!0 = metadata !{void (i16 addrspace(1)*, i16 addrspace(1)*, i16 addrspace(1)*)* @operator_substract_shortshort}
