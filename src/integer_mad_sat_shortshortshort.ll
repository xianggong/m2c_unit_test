...
define void @integer_mad_sat_shortshortshort(i16 addrspace(1)* %src_0, i16 addrspace(1)* %src_1, i16 addrspace(1)* %src_2) #0 {
  ...
  %tmp_13 = call signext i16 @_Z7mad_satsss(i16 signext %tmp_6, i16 signext %tmp_9, i16 signext %tmp_12)
...
!0 = metadata !{void (i16 addrspace(1)*, i16 addrspace(1)*, i16 addrspace(1)*)* @integer_mad_sat_shortshortshort}
